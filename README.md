...
| ------------        | ------------        | ------------ |------------ |
| *Análise de Clientes em um E-commerce* | [Everything Plus](https://github.com/Luizg39/Projetos_Practicum/blob/790cbd06724515e336bf9192f94d4a3248115e82/Projetos_Practicum/S2-Projeto_Inadiplencia/Projeto_Inadiplencia.ipynb) | Python, SQL, Tableau| *Um projeto completo de Análise de dados e Machine Learning, da definição do problema, dados filtrados em SQL, passando pela Análise Exploratória dos Dados (EDA - *Exploratory Data Analysis), tratamento, geração do modelo até o dashboard feito no Tableau, posteriormente um relatório final|
